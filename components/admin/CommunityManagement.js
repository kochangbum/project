      ...
      <SubContentContainer>
        ...
        {isModalOpen && selectedPost && selectedPost.postId && (
          <Modal
            ...
            message={
              <div className="post-details">
                ...
                <div className="post-meta-info">
                  ...
                  >
                    <div>
                      <strong></strong> {formatDate(selectedPost.communityDate)}
                    </div>
                    <div>
                      <strong>조회수:</strong> {selectedPost.postView}
                    </div>
                  </div>
                </div>
            ...
            width="800px" /* 모달의 너비를 80%로 설정 */
            height="auto" /* 모달의 높이는 내용에 맞춰 자동 조정 */
          />
        )}
      </SubContentContainer>
